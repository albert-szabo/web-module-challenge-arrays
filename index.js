...
const original31Flavors = copy(originalFlavors);
...
console.log(addFlavor(original31Flavors, 'Rainbow Sherbert'));
...
console.log(removeLastFlavor(original31Flavors));
...
console.log(getFlavorByIndex(original31Flavors, 2));
...
console.log(removeFlavorByName(original31Flavors, 'Rocky Road'));
...
// console.log(filterByWord(original31Flavors, 'Chocolate'));
